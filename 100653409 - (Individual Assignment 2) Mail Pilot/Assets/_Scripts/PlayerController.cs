...
public class PlayerController : MonoBehaviour
{
    ...
    BulletPoolManager BulletPoolMan;
    ...
    void Start()
    {
        ...
        BulletPoolMan = GameObject.FindObjectOfType<BulletPoolManager>();
    ...
    IEnumerator FireBullet()
    {
        while (true)
        {
            ...
            if (isFiring)
            {
                ...
                BulletPoolMan.GetBullet(bulletSpawn.position, Quaternion.identity); // Runs Get Bullet function from Bullet Pool Manager
            }
